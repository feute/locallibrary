...
class AuthorListViewTest(TestCase):
    ...
    def test_lists_all_authors(self):
        # Get second page and confirm it has (exactly) 3 items remaining.
...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_redirect_if_not_logged_in(self):
        ...
        self.assertRedirects(response, reverse('login')+'?next=/catalog/mybooks')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirect_if_logged_in_but_not_correct_permission(self):
        login = self.client.login(username='testuser1', password='password1')
        response = self.client.get(reverse('renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}))
        # Should get status 302 (redirect to login page) if raise_exception
        # was not given in the permission_required decorator. Otherwise,
        # should return 403.
        self.assertEqual(response.status_code, 302)
